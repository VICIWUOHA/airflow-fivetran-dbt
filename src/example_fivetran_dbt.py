...
args = {"owner": "airflow", "start_date": datetime.now(), "provide_context": True}
...
# create the DAG pipeline by setting dependencies using bitshift operators
(
